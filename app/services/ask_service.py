...
def _build_uncached_block_response(
    *,
    ...
    # Create a user-friendly message about insufficient credits
...
**Need immediate help?**
- Visit our Help Center for common tax questions
- Contact support for assistance

To continue using the AI assistant for complex tax questions, please upgrade your plan or purchase additional credits."""
    
    # Override the default answer with friendly message
