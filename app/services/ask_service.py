...
def _try_ai_generation(
    *,
    ...
    # Direct call to generate_grounded_answer (which will use OpenAI if enabled)
    try:
        ...
        debug["ai_generation_error"] = str(e)
...
def _process_ask_request(
    *,
    ...
    if ai_raw and isinstance(ai_raw, str) and len(ai_raw) > 10:
    ...
    # Final fallback (AI failed or returned empty)
