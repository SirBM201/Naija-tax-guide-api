...
def _cookie_mode_enabled() -> bool:
    ...
    Otherwise you might accidentally force credentialed CORS and break '*' origins.
    """
...
def create_app() -> Flask:
    ...
    required_modules = [
        ...
        "app.routes.ask",
        "app.routes.webhooks",      # includes paystack + meta verify endpoints in your current design
        "app.routes.plans",
    ...
    # ------------------------------------------------------------
    # OPTIONAL: legacy paystack modules (only if they exist)
    # ------------------------------------------------------------
    ...
    # ------------------------------------------------------------
    # Root-cause exposer (SAFE, no stack trace leakage)
    # ------------------------------------------------------------
